...
from FUNC.GATES.ccnfunc import *
import threading
import asyncio
from pathlib import Path
import concurrent.futures

@Client.on_message(filters.command("mccntxt", [".", "/"]))
            ...
            """
                        ...
                        try:
                            ...
                            if e == "'NoneType' object has no attribute 'download'":
                                resp = """𝗨𝗦𝗔𝗚𝗘:
𝗧𝗬𝗣𝗘 /massccntxt 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗥𝗘𝗣𝗟𝗬 𝗧𝗢 𝗔 𝗧𝗫𝗧 𝗙𝗜𝗟𝗘 𝗪𝗛𝗜𝗖𝗛 𝗖𝗢𝗡𝗧𝗔𝗜𝗡𝗦 𝗖𝗖 𝗜𝗡 𝗢𝗥𝗗𝗘𝗥 𝗧𝗢 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗚𝗔𝗧𝗘"""
                                await message.reply_text(resp, message.id)
...
𝗧𝗬𝗣𝗘 /massccntxt 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗥𝗘𝗣𝗟𝗬 𝗧𝗢 𝗔 𝗧𝗫𝗧 𝗙𝗜𝗟𝗘 𝗪𝗛𝗜𝗖𝗛 𝗖𝗢𝗡𝗧𝗔𝗜𝗡𝗦 𝗖𝗖 𝗜𝗡 𝗢𝗥𝗗𝗘𝗥 𝗧𝗢 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗚𝗔𝗧𝗘"""
                        ...
                        if getfile == "YES":
                            ...
                            if amt > 50 and role == "FREE":
                                ...
                                text = f"""
𝗚𝗮𝘁𝗲𝘀: <b>MASS CCN CHARGE 0.50$</b>
...
"""
                                ...
                                with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
                                    futures = []
                                    for i in file:
                                        future = executor.submit(masstxtccn,i,user_id)
...
<i>( total checked status will be updated after 20 cc checked done . this is for telegram limitation of message.edit )</i>
<b>Secret Key:</b> <code>{key}</code>
<i>( if checker got stuck or bot got stopped , then you can easily get your hits.txt file by typing "/gethits secretkey" this commands. )</i>
𝗦𝘁𝗮𝘁𝘂𝘀: <b>Checking</b>
