...
𝐆𝐀𝐓𝐄 ⟿ 𝐒𝐓𝐑𝐈𝐏𝐄 𝐁𝐀𝐒𝐄𝐃 𝟎.𝟓 𝐂𝐇𝐀𝐑𝐆𝐄𝐃 
              ...
              """
                            ...
                            elif "Invalid API Key provided" in result or "testmode_charges_only" in result or "api_key_expired" in result or "Expired API Key" in result:
                                status = "Dead 🔴"
                                response = "SK DEAD 🚫"
