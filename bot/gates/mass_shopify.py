...
@Client.on_message(filters.command("mchksh", [".", "/"]))
...
𝐃𝐎𝐍'𝐓 𝐓𝐑𝐘 𝐁𝐄𝐅𝐎𝐑𝐄 {after} 𝗦𝗘𝗖𝗢𝗡𝗗𝗦
            """
                        ...
                        if len(all_cards) > 9 and role == "FREE":
                            ...
                            resp = "𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐁𝐎𝐙𝐎𝐒 𝐂𝐀𝐍 𝐂𝐇𝐄𝐂𝐊 𝐔𝐏𝐓𝐎 25 𝗖𝗖 ❌"
                            PREMIUM = await Client.edit_message_text(
                                message.chat.id, stchk.id, resp)
                        else:
...
<i>( 𝐓𝐇𝐈𝐒 𝐆𝐀𝐓𝐄 𝐒𝐇𝐎𝐏𝐈𝐅𝐘 𝐈𝐒 𝐒𝐋𝐎𝐖! 𝐖𝐀𝐈𝐓 𝐀𝐍𝐃 𝐆𝐈𝐕𝐄 𝐈𝐓 𝐓𝐈𝐌𝐄 )</i>"""
                                nov = await Client.edit_message_text(
                                    message.chat.id, okst.id, resp)

                                text = f"""
<b>𝐆𝐀𝐓𝐄 ⟿ 𝐌𝐀𝐒𝐒 𝐒𝐇𝐎𝐏𝐈𝐅𝐘</b> \n
"""
                                amt = 0
                                with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
                                    futures = []
                                    for i in cards:
                                        future = executor.submit(mchkshopify,i,user_id)
